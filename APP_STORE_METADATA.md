...
- Campaign website
- Direct link to the candidate's ORESTAR account
...
Oregon,elections,candidates,ORESTAR,campaign finance,governor,legislature,House,Senate,politics

## App privacy response

Select **No, we do not collect data from this app**. The app has no accounts, advertising, analytics, tracking, or user-generated content.
...
1. **Oregon's Key Races, In One Place** — main screen showing multiple race cards.
